...
| Tabarkeras | Santa Pola | [tabarkeras.com](https://tabarkeras.com/) | WordPress + event-ticketing plugin (`/event/ticket-tabarkeras/`) | Deep link (seeded, verified 2026-08-30). One owner (NIF 48320818-A) runs an alias farm of 7+ domains (tabarqueras.com, ferryatabarca.com, …) — always dedupe to this record. Only brand advertising any Nov–Feb capability (fast boat, on demand). |
| Viajes Isla Tabarca | Santa Pola | [viajesislatabarca.com](https://viajesislatabarca.com/) | Own ticket app (app.viajesislatabarca.com) | Deep link (seeded, verified 2026-08-30). Transportes Marítimos Nueva Tabarca S.L.; the only operator publishing validity dates: daily 2 Mar – 31 Oct. Orange-branded like Tabarkeras but distinct legal entity/shop — watch for shared-fleet signs. |
| Transtabarca | Santa Pola | [islatabarca.com](https://www.islatabarca.com/) | WordPress site; own checkout at islatabarca.online (WooCommerce Bookings, open 30-day tickets) | Deep link (seeded; re-verified 2026-09-23). Shop sells every day of October; availability rule closes 1 Nov – 28 Feb. |
...
- **Re-verified 2026-08-17 (first real run of the timetable engine):** Kontiki simplified to one daily pattern — out 09:45/10:45/12:15/13:15, returns 16:00/18:15 (the 12:00 boat moved to 12:15, Fridays gained 13:15, the 17:30 return was dropped). Transtabarca reshuffled — 13 daily departures 09:00–19:45 plus 8 weekend fast-boat extras 08:30–14:45 (limited seats), returns gained a 19:00. Marítimas Torrevieja and all fares unchanged.
- **Santa Pola census (2026-08-30):** exactly three genuine vessel operators — Transtabarca (blue booths), Tabarkeras (orange, Muelle de Ribera), Viajes Isla Tabarca (orange booth Av. de los Baños). Confirmed **resellers, not operators**: Tabarca Experience S.L. (own aviso legal declares it an intermediary; bundles ferry + restaurant), tabarca.online and Eventos MultiAventura (both resell Tabarkeras). Cruceros Baeza Parodi is defunct (its legacy is today's Tabarkeras). Tabarca Water Taxi is real but publishes no timetable (excluded by policy). islatabarca.online is Transtabarca's own checkout, not a company.
- **Autumn re-verification (2026-09-23, five parallel agents on the official sites, applied via the timetable engine from that date; earlier patterns kept as history):** the drift tripwire had flagged four operators' pages (Sep 7–15) and all four had really changed. *Kontiki* (page edited Sep 21): 13:15 now Sat/Sun only; returns Mon–Fri 16:00 + 17:30, Sat 16:00 + 18:15, Sun all three; October = one daily 10:45 (the only sailing on sale 1–31 Oct, nothing after; their shop lists the midday boat as 12:00 while the page says 12:15 — page kept). *Transtabarca*: grid cut back to 10 daily catamarans 10:00–18:45 + 5 weekend fast-boat extras 09:30–14:45, 10 returns to 19:30; no dates published but the shop sells all of October and is closed 1 Nov – 28 Feb; catamaran ≈30 min; no ticket-office price published any more. *Tabarkeras* (page edited Sep 1): 15 departures 09:30–18:30 / 11 returns to 19:15, season ends 31 Oct (event ticket valid to that date, every October day bookable, November closed) — replaces the inferred minimum-service September grid; walk-up prices 12 €/10 €; CTAs now go to /billetes-barco-santa-pola-tabarca/. *Viajes Isla Tabarca*: page now publishes 14 departures 09:30–18:30 (13:30, 14:45 fast boat) / 11 returns to 19:15 in place of the 10/9 base table; season still 2 Mar – 31 Oct, "fuera de temporada la isla queda sin conexión regular". *Marítimas Torrevieja*: 10:45 daily to 30 Sep, then (shop only — no prose) October Mon–Thu + Sat and November Tue/Thu/Sat until Sat 21 Nov, 145 seats each; return encoded as the 17:30 departure from Tabarca (their visible timetable's definition; the previous 18:30 was the hidden text block's arrival-at-Torrevieja time — the site shows 17:30/18:00/18:30/19:00 in different places, confirm by phone if it matters). Materialization horizon moved to 21 Nov; next cliff: four operators end 31 Oct.
